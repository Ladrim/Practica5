...
public class Test15
{
    public static void main(String[] args) {
        ...
        Stream<String> nombres1 = Stream.of("Perico", "Delospalotes", "Benito", "Camelas").peek(a -> System.out.println(a)).map(nombre -> {
            return nombre.replace("e", "i");
        });
        Stream<String> nombres2 = Stream.of("Perico", "Delospalotes", "Benito", "Camelas").map(nombre -> {
